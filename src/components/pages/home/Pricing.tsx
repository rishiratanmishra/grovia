...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="py-28 border-t border-border-default/60 bg-transparent relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-text-primary mt-5">
            Simple, project-friendly pricing
          </h2>
          <p className="text-base sm:text-lg text-text-secondary mt-4 leading-relaxed">
            Choose the subscription that fits your project operations. All plans include automated daily report updates.
          </p>
